...
# ============================================================================
print("ðŸŽ¨ Generating Reddit word clouds by stance...")
print()
...
for idx, (stance_code, stance_name, color) in enumerate(stances):
    ...
    print(f"âœ“ Generated Reddit {stance_name} word cloud")

plt.tight_layout()
plt.savefig(OUTPUT_DIR / '01_reddit_wordclouds_by_stance.png', dpi=300, bbox_inches='tight')
print("âœ“ Saved: 01_reddit_wordclouds_by_stance.png")
print()

# ============================================================================
# 5. GENERATE WORD CLOUDS BY STANCE - YOUTUBE
# ============================================================================
print("ðŸŽ¨ Generating YouTube word clouds by stance...")
print()
...
for idx, (stance_code, stance_name, color) in enumerate(stances):
    ...
    print(f"âœ“ Generated YouTube {stance_name} word cloud")

plt.tight_layout()
plt.savefig(OUTPUT_DIR / '02_youtube_wordclouds_by_stance.png', dpi=300, bbox_inches='tight')
print("âœ“ Saved: 02_youtube_wordclouds_by_stance.png")
print()

# ============================================================================
# 6. SENTIMENT-BASED WORD CLOUDS - REDDIT
# ============================================================================
print("ðŸŽ¨ Generating Reddit word clouds by sentiment...")
print()
...
for idx, (sentiment, color) in enumerate(sentiments):
    ...
    print(f"âœ“ Generated Reddit {sentiment} word cloud")

plt.tight_layout()
plt.savefig(OUTPUT_DIR / '03_reddit_wordclouds_by_sentiment.png', dpi=300, bbox_inches='tight')
print("âœ“ Saved: 03_reddit_wordclouds_by_sentiment.png")
print()

# ============================================================================
# 7. SENTIMENT-BASED WORD CLOUDS - YOUTUBE
# ============================================================================
print("ðŸŽ¨ Generating YouTube word clouds by sentiment...")
print()
...
for idx, (sentiment, color) in enumerate(sentiments):
    ...
    print(f"âœ“ Generated YouTube {sentiment} word cloud")

plt.tight_layout()
plt.savefig(OUTPUT_DIR / '04_youtube_wordclouds_by_sentiment.png', dpi=300, bbox_inches='tight')
print("âœ“ Saved: 04_youtube_wordclouds_by_sentiment.png")
print()

# ============================================================================
# 8. PLATFORM COMPARISON - COMBINED WORD CLOUDS
# ============================================================================
print("ðŸŽ¨ Generating platform comparison word clouds...")
print()
...
print("âœ“ Saved: 05_platform_comparison_wordclouds.png")
print()

# ============================================================================
# 9. TOP WORDS EXTRACTION FOR REPORT
# ============================================================================
print("ðŸ“Š Extracting top words for each category...")
print()
...
print("âœ“ Saved: word_frequency_report.txt")
print()
...
# ============================================================================
print("="*70)
print("âœ… WORD CLOUD GENERATION COMPLETE")
print("="*70)
print()
...
print()
print("ðŸ“Š Total Visualizations: 5 (containing 13 word clouds)")
print()
