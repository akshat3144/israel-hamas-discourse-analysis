...
# LOAD DATA
# ============================================================================
print("\nðŸ“Š Loading sentiment-enhanced data...")
...
print(f"âœ“ Cleaned Reddit texts: {len(reddit_df):,}")
print(f"âœ“ Cleaned YouTube texts: {len(youtube_df):,}")
...
# Top words by stance
print("\nðŸ“Š TOP WORDS BY STANCE - REDDIT:")
for stance in ['P', 'I', 'N']:
...
print("âœ“ Reddit LDA complete")

# Display Reddit topics
print(f"\nðŸ“Š REDDIT - TOP {n_top_words} WORDS PER TOPIC:")
...
# YouTube LDA
print("\nðŸ” Running LDA on YouTube data...")
...
print("âœ“ YouTube LDA complete")

# Display YouTube topics
print(f"\nðŸ“Š YOUTUBE - TOP {n_top_words} WORDS PER TOPIC:")
...
print("âœ“ Reddit NMF complete")

# Display Reddit NMF topics
print(f"\nðŸ“Š REDDIT - TOP {n_top_words} WORDS PER TOPIC (NMF):")
...
# YouTube NMF
print("\nðŸ” Running NMF on YouTube data...")
...
print("âœ“ YouTube NMF complete")

# Display YouTube NMF topics
print(f"\nðŸ“Š YOUTUBE - TOP {n_top_words} WORDS PER TOPIC (NMF):")
...
print("âœ“ Saved: 01_word_frequency.png")
plt.close()
...
print("âœ“ Saved: 02_lda_topic_heatmaps.png")
plt.close()
...
print("âœ“ Saved: topic_modeling_report.txt")
