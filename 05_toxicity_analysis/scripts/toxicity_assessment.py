...
SENTIMENT_OUTPUT_DIR = ROOT_DIR / '01_rq1_emotional_tone' / 'outputs'
OUTPUT_DIR = ROOT_DIR / '04_rq4_toxicity' / 'outputs'
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / '01_platform_toxicity_comparison.png', dpi=300)
...
plt.xticks(rotation=0)
plt.tight_layout()
plt.savefig(OUTPUT_DIR / '02_reddit_toxicity_by_stance.png', dpi=300)
...
plt.xticks(rotation=0)
plt.tight_layout()
plt.savefig(OUTPUT_DIR / '03_youtube_toxicity_by_stance.png', dpi=300)
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / '04_identity_attack_distribution.png', dpi=300)
print("âœ“ Saved: 04_identity_attack_distribution.png")

# ============================================================================
# 5. GENERATE REPORT
# ============================================================================
with open(OUTPUT_DIR / 'perspective_analysis_report.txt', 'w') as f:
