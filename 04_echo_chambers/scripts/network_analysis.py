...
OUTPUT_DIR = ROOT_DIR / '04_echo_chambers' / 'outputs' / 'network'
...
if 'author_name' in reddit_df.columns:
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '01_user_stance_distribution.png', dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '02_user_consistency.png', dpi=300)
...
if len(active_users) > 0 and 'post_id' in reddit_df.columns:
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '03_echo_chamber_index.png', dpi=300)
...
if len(active_users) > 0 and 'post_id' in reddit_df.columns:
    ...
    plt.axis('off')
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '04_user_network_graph.png', dpi=300)
