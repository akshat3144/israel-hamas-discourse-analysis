...
if len(reg_df) > 0:
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '01_regression_coefficients.png', dpi=300)
...
if 'controversiality' in reddit_df.columns and 'score' in reddit_df.columns:
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '02_amplification_controversy.png', dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '03_amplification_by_stance.png', dpi=300)
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / '04_complexity_platform_comparison.png', dpi=300)
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / '05_complexity_by_stance.png', dpi=300)
