...
if 'author_name' in reddit_df.columns:
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '06_network_top_users.png', dpi=300)
...
if 'created_time' in reddit_df.columns and 'post_created_time' in reddit_df.columns:
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '07_response_time_distribution.png', dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '08_response_time_by_stance.png', dpi=300)
...
if len(reddit_vol) > 0 and len(youtube_vol) > 0:
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / '09_conversation_volume.png', dpi=300)
